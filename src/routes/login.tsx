  ...
  return (
    <div className="flex min-h-screen flex-col bg-background">
        ...
        <div className="grid w-full max-w-5xl gap-12 lg:grid-cols-2 lg:items-center">
          ...
          <div className="rounded-3xl border border-border bg-card p-8 shadow-[var(--shadow-elegant)]">
            ...
            >
              ...
              <Button type="submit" className="h-11 w-full text-sm font-medium" disabled={isSigningIn}>
                {isSigningIn ? "Signing in..." : "Sign in"} <ArrowRight className="ml-1 h-4 w-4" />
              </Button>
            </form>
      ...
      <RegisterModal
        ...
        onComplete={async (u) => {
          if (!password) {
            toast.error("Enter a password in the sign-in form before creating an account");
            return;
          }
